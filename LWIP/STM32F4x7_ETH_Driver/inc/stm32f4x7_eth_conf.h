...
//#define PHY_SR				((uint16_t)16) 		//DP83848µÄPHY×´Ì¬¼Ä´æÆ÷µØÖ·
//#define PHY_SPEED_STATUS    ((uint16_t)0x0002) 	//DP83848 PHYËÙ¶ÈÖµÑÚÂë
//#define PHY_DUPLEX_STATUS   ((uint16_t)0x0004) //DP83848 PHYÁ¬½Ó×´Ì¬ÖµÑÚÂë  
