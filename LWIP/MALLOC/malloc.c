...
__align(32) u8 mem3base[MEM3_MAX_SIZE] __attribute__((at(0X10004000)));					//内部CCM内存池
//内存管理表
u16 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];																								//内部SRAM内存池MAP
u16 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0x680E8000)));	//外部SRAM内存池MAP
u16 mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((at(0x1000E000)));	//内部CCM内存池MAP
//内存管理参数	   
