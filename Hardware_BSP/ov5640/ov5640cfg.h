// ov5640cfg.h - OV5640 Camera Configuration Tables
// This file contains register configuration tables for different modes
...
// OV5640 JPEG Mode Register Table (640x480 VGA)
static const uint16_t ov5640_jpeg_reg_tbl[][2] = 
{
    0x4300, 0x30,  // JPEG mode (key modification!)
    0x501f, 0x00,  // YUV 422 (consistent with success case)
    // Input clock = 24Mhz
    0x3035, 0x21,  // PLL
    0x3036, 0x69,  // PLL
...
// OV5640 RGB565 Mode Register Table (160x120)
...
// OV5640 Initialization Register Table (key configuration)
